...
%let EM_NUM_VARS = 11;
   %macro EM_VARS;
    _SEGMENT_ households housing_median_age latitude longitude median_house_value
   median_income ocean_proximity population total_bedrooms total_rooms
   %mend EM_VARS;
%let EM_NUM_CLASS = 2;
   %macro EM_CLASS;
    _SEGMENT_ ocean_proximity
   %mend EM_CLASS;
%let EM_NUM_INTERVAL = 9;
   %macro EM_INTERVAL;
