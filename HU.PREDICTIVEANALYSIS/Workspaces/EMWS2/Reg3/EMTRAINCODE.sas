...
role = TEST
;
code file="\\uisnutvdiprof1a\redirected$\smupp\Documents\HU.PREDICTIVEANALYSIS\Workspaces\EMWS2\Reg3\EMPUBLISHSCORE.sas"
group=Reg3
;
code file="\\uisnutvdiprof1a\redirected$\smupp\Documents\HU.PREDICTIVEANALYSIS\Workspaces\EMWS2\Reg3\EMFLOWSCORE.sas"
group=Reg3
residual
;
run;
