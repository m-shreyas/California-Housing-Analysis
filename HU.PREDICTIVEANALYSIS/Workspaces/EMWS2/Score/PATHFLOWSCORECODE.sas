...
* Encoding: wlatin1;
* Locale: en_US;
* Project Path: \\uisnutvdiprof1a\redirected$\smupp\Documents;
* Project Name: HU.PREDICTIVEANALYSIS;
* Diagram Id: EMWS2;
* Diagram Name: HU.Prediction;
* Generated by: smupp;
* Date: 11DEC2024:00:20:58;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
...
* NODE: MdlComp;
*------------------------------------------------------------*;
if (P_median_house_value ge 395091.198641086) then do;
b_median_house_val = 1;
end;
else
if (P_median_house_value ge 357740.513157894) then do;
b_median_house_val = 2;
end;
else
if (P_median_house_value ge 326642.556959706) then do;
b_median_house_val = 3;
end;
else
if (P_median_house_value ge 275646.79032258) then do;
b_median_house_val = 4;
end;
else
if (P_median_house_value ge 264273.903474903) then do;
b_median_house_val = 5;
end;
else
if (P_median_house_value ge 244583.589552238) then do;
b_median_house_val = 6;
end;
else
if (P_median_house_value ge 216912.448770491) then do;
b_median_house_val = 7;
end;
else
if (P_median_house_value ge 211919.223376623) then do;
b_median_house_val = 8;
end;
else
if (P_median_house_value ge 207535.02616279) then do;
b_median_house_val = 9;
end;
else
if (P_median_house_value ge 190109.523809523) then do;
b_median_house_val = 10;
end;
else
if (P_median_house_value ge 182580.594720496) then do;
b_median_house_val = 11;
end;
else
if (P_median_house_value ge 169298.550724637) then do;
b_median_house_val = 12;
end;
else
if (P_median_house_value ge 149679.298076923) then do;
b_median_house_val = 13;
end;
else
if (P_median_house_value ge 140012.229275578) then do;
b_median_house_val = 14;
end;
else
if (P_median_house_value ge 126782.336599986) then do;
b_median_house_val = 15;
end;
else
if (P_median_house_value ge 125178.448844884) then do;
b_median_house_val = 16;
end;
else
if (P_median_house_value ge 100689.291497975) then do;
b_median_house_val = 17;
end;
else
if (P_median_house_value ge 86015.7894736842) then do;
b_median_house_val = 18;
end;
else
if (P_median_house_value ge 81488.7626262626) then do;
b_median_house_val = 19;
end;
else
do;
b_median_house_val = 20;
end;
*------------------------------------------------------------*;
* TOOL: Model Compare Class;
* TYPE: ASSESS;
...
LABEL = 'Target Variable: median_house_value';
EM_VALUETARGET = median_house_value;
